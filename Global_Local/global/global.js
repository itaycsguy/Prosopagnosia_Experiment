var Functions = {
	...
	"changeContent":function(){
		var str = "<tr><td><h2><strong>מהי הצורה הגדולה?</strong></h2>";
	...
	"uploadRest":function(){
		...
		if(Functions.breaks_num > 0)
		{
			...
			str += "<tr><td><h4>עליך להחליט מהי הצורה של הצורה הגדולה</h4></td></tr>";
		}
	...
	"putFeedback":function(event){
		...
		var image_name = Functions.imgs_b[Functions.permut[Functions.img_idx-1]];
		//var i = Functions.permut[Functions.img_idx-1];
		//console.log(i === Functions.permut[Functions.img_idx-1]);
		//console.log("image_name: "+image_name+", event.keyCode: "+event.keyCode);
		if(image_name == "ריבוע")
		{
			if(event.keyCode == 90){
				correct_flag = true;
...
var Form = {
	"ajax":function(event){
		...
		var url = "/recognitions/dev/global.php";
