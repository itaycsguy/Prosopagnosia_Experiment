...
var Functions = {
	...
	"preload":function(){
		...
		{
			var myImgPath_a = "/recognitions/test6/"+Functions.imgs_a_type1[i];
			var myImgPath_b = "/recognitions/test6/"+Functions.imgs_b_type1[i];
			var myImgPath_c = "/recognitions/test6/"+Functions.imgs_c_type1[i];
			var img_a = new Image();
			var img_b = new Image();
			var img_c = new Image();
		...
		{
			var myImgPath_a = "/recognitions/test6/"+Functions.imgs_a_type2[i];
			var myImgPath_b = "/recognitions/test6/"+Functions.imgs_b_type2[i];
			var img_a = new Image();
			var img_b = new Image();
			img_a.src = myImgPath_a; // make the preload
			img_b.src = myImgPath_b; // make the preload
		...
		{
			var myImgPath_a = "/recognitions/test6/"+Functions.imgs_a_type3[i];
			var myImgPath_b = "/recognitions/test6/"+Functions.imgs_b_type3[i];
			var img_a = new Image();
			var img_b = new Image();
			img_a.src = myImgPath_a; // make the preload
			img_b.src = myImgPath_b; // make the preload
	...
	"showPreview1":function(){
		...
		str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_1++] + " id='curr_img' alt='face' width='" + Functions.img_width + "px' height='" + Functions.img_width + "px'/></td></tr>";
		...
		var func = function(curr_img){
			...
			var myPreview = window.setInterval(function(){
				if(localCounter == 2){
					...
					curr_img.src = "/recognitions/test6/" + img[Functions.img_idx_1++];
					localCounter++;
				}
			},3000);
		}
	...
	"showQuestions1":function(){
		var str = "<tr><td><h2><strong>איזה פרצוף הופיע?</strong></h2></td></tr>";
		str += "<tr><td><h4><strong>[נא ללחוץ על מספר התמונה המתאים]</strong></h4></td></tr>";
		var img = Functions.imgs_b_type1; // factory
		str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_1-2] + " id='curr_img1' width='" + (3*Functions.img_width) + "px' height='" + Functions.img_width + "px'/></td></tr>";
	...
	"showPreview2":function(){
		...
		str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_2] + " id='curr_img' alt='face'/></td></tr>";
		//str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_2] + " id='curr_img' alt='face' width='" + (3*Functions.img_width) + "px' height='" + (3*Functions.img_width) + "px'/></td></tr>";
		Functions.img_idx_2++;
		document.getElementById("table").innerHTML = str;
		var curr_img = document.getElementById("curr_img");
		var func = function(curr_img){
	...
	"showQuestions2":function(){
		...
		str += "<tr><td><h4><strong>[נא ללחוץ על מספר התמונה המתאים]</strong></h4></td></tr>";
		var img = Functions.imgs_a_type2; // factory
		str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_2] + " id='curr_img1' width='" + (3*Functions.img_width) + "px' height='" + Functions.img_width + "px'/></td></tr>";
		str += "<br><tr><td><strong><label style='padding-left:33%;'><img src='/recognitions/dev/3.png'></label><label><img src='/recognitions/dev/2.png'></label><label style='padding-right:33%;'><img src='/recognitions/dev/1.png'></label></strong></td></tr>";
		//str += "<br><tr><td><strong><label style='padding-left:33%;'>-3-</label><label>-2-</label><label style='padding-right:33%;'>-1-</label></strong></td></tr>";
		Functions.img_idx_2++;
		document.getElementById("table").innerHTML = str;
	...
	"showPreview3":function(){
		...
		str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_3] + " id='curr_img' alt='face'/></td></tr>";
		//str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_3] + " id='curr_img' alt='face' width='" + (3*Functions.img_width) + "px' height='" + (3*Functions.img_width) + "px'/></td></tr>";
		Functions.img_idx_3++;
		document.getElementById("table").innerHTML = str;
		var curr_img = document.getElementById("curr_img");
		var func = function(curr_img){
	...
	"showQuestions3":function(){
		...
		str += "<tr><td><img src=" + "/recognitions/test6/" + img[Functions.img_idx_3] + " id='curr_img1' width='" + (3*Functions.img_width) + "px' height='" + Functions.img_width + "px'/></td></tr>";
		str += "<br><tr><td><strong><label style='padding-left:33%;'><img src='/recognitions/dev/3.png'></label><label><img src='/recognitions/dev/2.png'></label><label style='padding-right:33%;'><img src='/recognitions/dev/1.png'></label></strong></td></tr>";
		//str += "<br><tr><td><strong><label style='padding-left:33%;'>-3-</label><label>-2-</label><label style='padding-right:33%;'>-1-</label></strong></td></tr>";
		Functions.img_idx_3++;
		document.getElementById("table").innerHTML = str;
...
var Form = {
	"ajax":function(event){
		...
		if(Functions.type == 1) {
			...
			var faces_1_index = Functions.img_idx_1/3;
			packeta = "answers="+JSON.stringify([Functions.type,key_in,imgL,imgM,imgR,Functions.imgs_c_type1[faces_1_index-1],isTraining,Functions.clock,faces_1_index]);
		...
		var url = "/recognitions/dev/faces.php";
	...
	"transfer":function(){
		window.location.href = "/recognitions/dev/details.php?returnTask='8'";
	}
};